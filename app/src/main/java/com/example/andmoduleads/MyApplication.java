...
public class MyApplication extends AdsMultiDexApplication {
    ...
    private void initAds() {
        String environment = BuildConfig.env_dev ? AdUtilsConfig.ENVIRONMENT_DEVELOP : AdUtilsConfig.ENVIRONMENT_PRODUCTION;
        mAdUtilsConfig = new AdUtilsConfig(this, AdUtilsConfig.PROVIDER_ADMOB, environment);
        ...
        mAdUtilsConfig.setAdjustConfig(adjustConfig);

        // Optional: setup Appsflyer event
//        AppsflyerConfig appsflyerConfig = new AppsflyerConfig(true,APPSFLYER_TOKEN);

        // Optional: enable ads resume
        mAdUtilsConfig.setIdAdResume(BuildConfig.ads_open_app);

        // Optional: setup list device test - recommended to use
        listTestDevice.add("EC25F576DA9B6CE74778B268CB87E431");
        mAdUtilsConfig.setListDeviceTest(listTestDevice);
        mAdUtilsConfig.setIntervalInterstitialAd(15);

        AdUtils.getInstance().init(this, mAdUtilsConfig, false);
