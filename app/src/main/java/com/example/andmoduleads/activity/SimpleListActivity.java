...
public class SimpleListActivity extends AppCompatActivity {
    ...
    private void setupAdAdapter() {
        adAdapter = AdUtils.getInstance().getNativeRepeatAdapter(this, idNative, layoutCustomNative, com.ads.control.R.layout.layout_native_medium,
