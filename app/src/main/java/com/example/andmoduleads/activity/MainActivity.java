...
import com.ads.control.ads.bannerAds.AdUtilsBannerAdView;
import com.ads.control.ads.nativeAds.AdUtilsNativeAdView;
...
public class MainActivity extends AppCompatActivity {
    ...
    private AdUtilsNativeAdView mAdUtilsNativeAdView;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_main);
        mAdUtilsNativeAdView = findViewById(R.id.adNativeAds);


        configMediationProvider();
        AdUtils.getInstance().setCountClickToShowAds(3);
         ...
         */
        mAdUtilsNativeAdView.loadNativeAd(this, idNative, new AdUtilsCallback() {
            @Override
        ...
        AdUtilsBannerAdView bannerAdView = findViewById(R.id.bannerView);
        bannerAdView.loadBanner(this, idBanner, new AdUtilsCallback() {
            @Override
            public void onAdImpression() {
                super.onAdImpression();
            }
        ...
        findViewById(R.id.btShowAds).setOnClickListener(v -> {
            if (mInterstitialAd.isReady()) {
                ...
                ApInterstitialAd inter = AdUtils.getInstance().getInterstitialAds(this, idInter);

                AdUtils.getInstance().showInterstitialAdByTimes(this, mInterstitialAd, new AdUtilsCallback() {
                    @Override
        ...
        findViewById(R.id.btForceShowAds).setOnClickListener(v -> {
            if (mInterstitialAd.isReady()) {
                AdUtils.getInstance().forceShowInterstitial(this, mInterstitialAd, new AdUtilsCallback() {
                    @Override
                    public void onNextAction() {
        ...
        findViewById(R.id.btnShowReward).setOnClickListener(v -> {
            if (rewardAd != null && rewardAd.isReady()) {
                AdUtils.getInstance().forceShowRewardAd(this, rewardAd, new AdUtilsCallback());
                return;
            }
            rewardAd = AdUtils.getInstance().getRewardAd(this,  BuildConfig.ad_reward);
        });
    ...
    private void configMediationProvider() {
        if (AdUtils.getInstance().getMediationProvider() == AdUtilsConfig.PROVIDER_ADMOB) {
    ...
    private void loadAdInterstitial() {
        ...
        mInterstitialAd = AdUtils.getInstance().getInterstitialAds(this, idInter);
    }


    public void onTrackSimpleEventClick(View v) {
        AdUtilsAdjust.onTrackEvent(EVENT_TOKEN_SIMPLE);
    }

    public void onTrackRevenueEventClick(View v) {
        AdUtilsAdjust.onTrackRevenue(EVENT_TOKEN_REVENUE, 1f, "EUR");
    }
