...
public class AppOpenMax implements Application.ActivityLifecycleCallbacks, LifecycleObserver {
    ...
    private AdUtilsCallback AdUtilsCallback;
    ...
    public void loadAdResumeMax(Application application, String appOpenAdId) {
        ...
        appOpenAd.setListener(new MaxAdListener() {
            ...
            public void onAdLoaded(MaxAd ad) {
                ...
                if (AdUtilsCallback != null) {
                    AdUtilsCallback.onAdLoaded();
                }
            }
            ...
            public void onAdDisplayed(MaxAd ad) {
                ...
                if (AdUtilsCallback != null) {
                    AdUtilsCallback.onAdImpression();
                }
            }
            ...
            public void onAdLoadFailed(String adUnitId, MaxError error) {
                ...
                dismissDialogLoading();
                if (AdUtilsCallback != null) {
                    AdUtilsCallback.onAdFailedToLoad(new ApAdError(error));
                }
            }
            ...
            public void onAdDisplayFailed(MaxAd ad, MaxError error) {
                ...
                dismissDialogLoading();
                if (AdUtilsCallback != null) {
                    AdUtilsCallback.onAdFailedToShow(new ApAdError(error));
                }
            }
        });
        appOpenAd.loadAd();
    ...
    public void setAppOpenMaxCallback(AdUtilsCallback AdUtilsCallback) {
        this.AdUtilsCallback = AdUtilsCallback;
    }
