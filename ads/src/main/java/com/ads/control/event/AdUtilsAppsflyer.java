...
public class AdUtilsAppsflyer {
    private static final String TAG = "AdUtilsAppsflyer";
    private Context context;
    private static AdUtilsAppsflyer sAdUtilsAppsflyer;
    public static boolean enableAppsflyer = false;

    public AdUtilsAppsflyer() {
    }

    public static AdUtilsAppsflyer getInstance(){
        if (sAdUtilsAppsflyer ==null)
            sAdUtilsAppsflyer = new AdUtilsAppsflyer();
        return sAdUtilsAppsflyer;
    }
