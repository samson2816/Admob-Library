...
public class AdUtilsPlacerSettings {
    ...
    private AdUtilsPlacer.Listener listener;
    public AdUtilsPlacerSettings(String adUnitId, int layoutCustomAd, int layoutPlaceHolderAd) {
        this.adUnitId = adUnitId;
        this.layoutCustomAd = layoutCustomAd;
        this.layoutAdPlaceHolder = layoutPlaceHolderAd;
    }
    public AdUtilsPlacerSettings(int layoutCustomAd, int layoutPlaceHolderAd) {
        this.adUnitId = adUnitId;
        this.layoutCustomAd = layoutCustomAd;
        this.layoutAdPlaceHolder = layoutPlaceHolderAd;
    }
    ...
    public AdUtilsPlacer.Listener getListener() {
        return listener;
    }

    public void setListener(AdUtilsPlacer.Listener listener) {
